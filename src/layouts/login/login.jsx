          ...
          this.state.ok ? (
            <div className="form" id="register-form">
              <div className="login-head " style={{ color: "white" }}>
                <img style={{height:'40px',width:'40px'}} src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/..Uttarakhand_Flag%28INDIA%29.png/220px-..Uttarakhand_Flag%28INDIA%29.png"/>
              </div>
